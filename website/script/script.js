...
// Add mouseleave event listener to the custom select. CLOSE DROPDOWN WHEN CLICKED ANYWHERE
...
// Event listener for location selection. UPDATE THE SELECTED LOCATION'S NEWS
...
// Function to truncate title text
function truncateTitle(title, maxLength) {
    if (!title) return ""; // Return empty string if title is null or undefined
        ...
        if (data.articles && data.articles.length > 0) {
            ...
            filteredArticles.forEach((article) => {
                ...
                if (article.urlToImage && article.urlToImage !== "null" && article.urlToImage !== null) {
                    ...
                    switch (category) {
                        case "sports":
                            image.src = "../images/s1.jpeg";
                            break;
                        case "business":
                            image.src = "../images/b1.jpeg";
                            break;
                        case "entertainment":
                            image.src = "../images/e1.jpeg";
                            break;
                        case "technology":
                            image.src = "../images/t1.jpeg";
                            break;
                        default:
                            // Use a default image for other categories
                            image.src = "../images/default_image.jpeg";
                            break;
                    }
                }
...
// Function to filter and display news by category
async function filterSidebar(category) {
    try {
        let apiUrl = `https://newsapi.org/v2/top-headlines?country=us&category=${category}&apiKey=${apiKey}`;
        console.log("API URL:", apiUrl);
...
// Event listener for submenu items under Health
document.querySelector('.submenu').addEventListener('click', function () {
    filterSidebar('submenu');
